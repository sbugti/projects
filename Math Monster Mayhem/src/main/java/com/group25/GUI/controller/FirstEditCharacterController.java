...
/**
 * Controller class for the first edit character scene.
 * @author Adam Murdock Gale, Sameer Mehboob Bugti, Saad Meshaal Koker, Jesse Titus, Fahmid Abdullah 
 */
public class FirstEditCharacterController {
    ...
    // Initialize function to set outfit based on currentUser
    @FXML
    ...
    /**
     * Selects the hat based on the given hat number.
     * @param hatNumber The hat number to select.
     */
    ...
    /**
     * Selects the skin based on the given skin number.
     * @param skinNumber The skin number to select.
     */
    ...
    /**
     * Selects the shirt based on the given shirt number.
     * @param shirtNumber The shirt number to select.
     */
    ...
    /**
     * Updates the UI components based on the selected values.
     */
    ...
    /**
     * Handles the save button click event. Updates the user's outfit and saves the user's data.
     * If successful, displays a feedback label for one second and navigates to the main scene.
