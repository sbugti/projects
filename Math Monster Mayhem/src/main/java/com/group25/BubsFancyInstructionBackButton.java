...
/**
 * The BubsFancyInstructionBackButton class represents a custom styled button.
 ...
 */
public class BubsFancyInstructionBackButton extends Button {
     ...
     */
    public BubsFancyInstructionBackButton() {
        super();
        init();
    }
     ...
     */
    public BubsFancyInstructionBackButton(String text) {
        super(text);
        init();
    }
     ...
     */
    private void init() {
        setStyle("-fx-background-color: black;"); // Set default style
        ...
        setOnMouseExited(e -> setStyle("-fx-background-color: black;")); // Restore default style
